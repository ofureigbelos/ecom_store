...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2019 at 08:05 AM
...
(1, 'Modren E commerce Store', 'Saad Ahmed', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'modren,ecommerce,store,multivendor', 'yes', 'pending', 'yes', 'yes', 'completed');
